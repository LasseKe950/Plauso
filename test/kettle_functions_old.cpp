...
int prev_litres;
unsigned char water_measure_error, food_sensor_error, kettle_sensor_error, hataseis_painettu;
...
{
   if (chilling_vaihe==0)
      output_registers[OUTPUT_REG_CARD1_DIGITAL_OUTPUTS] &= ~(EMPTYING_MV4_24V_OUT_BIT_CARD1 | BYBASS_MV6_24V_OUT_BIT_CARD1);
   else
      output_registers[OUTPUT_REG_CARD1_DIGITAL_OUTPUTS] &= ~(EMPTYING_MV4_24V_OUT_BIT_CARD1);
...
{
   output_registers[OUTPUT_REG_CARD1_DIGITAL_OUTPUTS] |= (EMPTYING_MV4_24V_OUT_BIT_CARD1 | BYBASS_MV6_24V_OUT_BIT_CARD1 | ILMANPOISTIN_MV7_24V_OUT_BIT_CARD1);
}
...
//      run_target_params.mixer_mode = 0;
   ...
   if (run_target_params.mixer_speed > 200)
      run_target_params.mixer_speed = 200;
   ...
   {
      output_registers[OUTPUT_REG_CARD2_DIGITAL_OUTPUTS] &= ~INVERTER_ON_3V_OUT_BIT_CARD2;
   }
