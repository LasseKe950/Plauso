...
LButton *DEMO_tausta1 = nullptr;
LButton *DEMO_tausta2 = nullptr;
...
void init_DEMO(void)
{
   DEMO_tausta1 = new LButton(Tausta1_X, Tausta1_Y, nullptr, (char*)"kuva0_640x400.png", BUTTON_TYPE_CLOCK);
   if (DEMO_tausta1 == nullptr)
      printf( "Failed to create new Button!\n" );
   else
   {
      DEMO_tausta1->set_size(400, 640);
   }
}
